export const Icons = {
  groups: {
    ...
    class: "mt-1 h-8 w-8 shrink-0 fill-neutral-500 dark:fill-neutral-400",
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      "mt-2 h-6 w-6 shrink-0 fill-neutral-700 hs-tab-active:fill-neutral-500 dark:fill-neutral-300 dark:hs-tab-active:fill-neutral-400 md:h-7 md:w-7",
    width: 48,
    height: 48,
    viewBox: "0 -960 960 960",
  },
  ...
  house: {
    ...
    class:
      "h-6 w-6 shrink-0 text-neutral-700 hs-tab-active:text-neutral-500 dark:text-neutral-300 dark:hs-tab-active:text-neutral-400 md:h-7 md:w-7",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
